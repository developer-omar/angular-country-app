...
const typeMap: any = {
  ...
  Currencies: o([{ json: 'EUR', js: 'EUR', typ: r('Eur') }], false),
  Eur: o(
    [
  ...
  Gini: o([{ json: '2018', js: '2018', typ: 3.14 }], false),
  Idd: o(
    [
  ...
  Languages: o([{ json: 'est', js: 'est', typ: '' }], false),
  Maps: o(
    [
  ...
  NativeName: o([{ json: 'est', js: 'est', typ: r('Translation') }], false),
  Translation: o(
    [
      { json: 'official', js: 'official', typ: '' },
      { json: 'common', js: 'common', typ: '' },
